...
@interface search ()<UISearchBarDelegate,UITableViewDelegate,UITableViewDataSource,NSFetchedResultsControllerDelegate>{
...
//blog:https://www.cnblogs.com/Camier-myNiuer/p/5803305.html
- (void)viewDidLoad {
    [super viewDidLoad];
